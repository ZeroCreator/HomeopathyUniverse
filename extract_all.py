...
ROWS = [
    {"id": 1, "label": "Вселенная / Ряд Водорода", "miasm": "Острый миазм", "creationDay": "1", "description": "Первый ряд. Водород. Начало, идея, мечта, энтропия."},
    {"id": 2, "label": "Пространство / Ряд Углерода", "miasm": "Сикотический миазм", "creationDay": "2", "description": "Второй ряд. Углерод. Пространство, любовь, познание, биполярность."},
    {"id": 3, "label": "Море, суша, бактерии, грибы, растения / Ряд Кремния", "miasm": "Псорический миазм", "creationDay": "3", "description": "Третий ряд. Кремний. Море и суша, растения, вирусы и бактерии."},
    {"id": 4, "label": "Время / Ряд Железа", "miasm": "Сифилитический миазм", "creationDay": "4", "description": "Четвёртый ряд. Железо. Время, работа, смена, сифилитический миазм."},
    {"id": 5, "label": "Животные водные, птицы, насекомые / Ряд Серебра", "miasm": "Туберкулиновый миазм", "creationDay": "5", "description": "Пятый ряд. Серебро. Водные животные, птицы, насекомые."},
    {"id": 6, "label": "Животные млекопитающие, наземные, человек / Ряд Золота", "miasm": "Раковый миазм", "creationDay": "6", "description": "Шестой ряд. Золото. Млекопитающие, человек, раковый миазм."},
    {"id": 7, "label": "Добро и зло / Ряд Урана", "miasm": "Лепрозный миазм", "creationDay": "7", "description": "Седьмой ряд. Уран. Добро и зло, метафизика, лепрозный миазм."},
    {"id": "6a", "label": "Лантаноиды", "miasm": "", "creationDay": "", "description": "Лантаноиды. Внутреннее воодушевление, сакральный момент."},
    {"id": "7a", "label": "Актиноиды", "miasm": "", "creationDay": "", "description": "Актиноиды. Проекция, путь, радиоактивность."},
]
